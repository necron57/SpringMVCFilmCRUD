...
<body>
	...
	<form action="showFilm.do" method="POST">
		<label for="filmId">Enter the ID to search by: </label> <br> <input
			type="number" name="filmId"> <br>
...
<p>--------------------------------------------------------------------------------------</p>
			...
			<form action="updateFilm.do" method="POST">
				...
				<br> <br> <label for="description">Enter in the
					new Description:</label> <input type="text" name="description"
					value="${film.description }"> <br> <br> <label
					for="languageId">Enter in the new Language ID:</label> <input
					type="number" name="languageId" value="${film.languageId }">
				<br> <br> <label for="filmId">Choose the Film ID
					that should be updated with this new info:</label> <input type="number"
					name="filmId" value="${film.id }"> <br> <br>
	...
	<form action="showByKeyWord.do" method="POST">
		<label for="filmKeyword">Enter the keyword to search: </label> <br>
	...
	<c:when test="${not empty films }">
		<c:forEach var="item" items="${films }">
			...
			<form action="updateFilm.do" method="POST">
				...
				<br> <br> <label for="description"> Enter in the
					new Description:</label> <input type="text" name="description"
					value="${item.description }"> <br> <br> <label
					for="languageId"> Enter in the new Language ID:</label> <input
					type="number" name="languageId" value="${item.languageId }">
				<br> <br> <label for="filmId">Choose the Film ID
					that should be updated with this new info:</label> <input type="number"
					name="filmId" value="${item.id }"> <br> <br>
				<button>Update Film</button>
			</form>
			<br />
			<p>--------------------------------------------------------------------------------------</p>
